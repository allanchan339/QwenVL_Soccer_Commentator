# As MuseTalk contains too many hardcoded paths, it is not recommended to use it as a submodule. Instead, we implement a static backup for MuseTalk for this project usage. 
